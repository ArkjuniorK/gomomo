...
// Declare and register API middleware, make sure it returns
// fiber.Handler type otherwise it won't be added to API.

// InitAPIMiddleware would inject the middleware to application API,
// middleware could also pass as arguments.
func InitAPIMiddleware(api *core.API, mws ...interface{}) {
